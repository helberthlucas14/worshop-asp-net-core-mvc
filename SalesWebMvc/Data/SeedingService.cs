...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1992, 4, 21), 1000.00, d1);
            ...
            Seller s5 = new Seller(5, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.00, d4);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);


            SalesRecord r1 = new SalesRecord(1, new DateTime(DateTime.Now.Year, 09, 25), 11000.0, SaleStatus.Billed, s1);
            ...
            SalesRecord r7 = new SalesRecord(7, new DateTime(DateTime.Now.Year, 09, 28), 13000.0, SaleStatus.Billed, s2);
            ...
            SalesRecord r11 = new SalesRecord(11, new DateTime(DateTime.Now.Year, 09, 13), 6000.0, SaleStatus.Billed, s2);
